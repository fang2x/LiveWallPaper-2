...
public class VideoLiveWallpaper extends WallpaperService {
	...
	public static final String VIDEO_PARAMS_CONTROL_ACTION = "com.cherish.livewallpaper";
	...
	public static void setToWallPaper(Activity activity, int requestCode) {
		final Intent intent = new Intent(WallpaperManager.ACTION_CHANGE_LIVE_WALLPAPER);
		intent.putExtra(WallpaperManager.EXTRA_LIVE_WALLPAPER_COMPONENT,
				new ComponentName(activity, VideoLiveWallpaper.class));
